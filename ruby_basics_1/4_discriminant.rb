...
if discriminant.negative? then puts "Дискриминант: #{discriminant}. Корней нет."
elsif discriminant.zero? then puts "Дискриминант: #{discriminant}. Корень: #{x1}."
elsif discriminant.positive? then puts "Дискриминант: #{discriminant}. Корень 1: #{x1}, Корень 2: #{x2}."
end
